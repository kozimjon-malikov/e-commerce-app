...
@section('content')
    <section class="content-header">
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{ url('update_product_confirm',$product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    ...
                    <div class="widget-user-image" style="position: relative;left: 280px;top:5px;margin:10px">
                        <img src="{{ asset('product/' . $product->image) }}" class="" width="140px" alt="">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{ $product->discount_price }}" name="dis_price"
                                class="form-control" id="price" placeholder="Discount_price">
                        </div>
                    </div>
